...
export default function ChatInput({ onSendMessage, isLoading }: ChatInputProps) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-96 bg-white border-t border-gray-200 p-6">
      <div className="max-w-4xl mx-auto">
        <form onSubmit={handleSubmit} className="relative">
          <div className="flex items-center gap-3 bg-gray-50 rounded-full border border-gray-200 px-6 py-3 focus-within:border-purple-300 focus-within:ring-2 focus-within:ring-purple-100 transition-all">
            <button
              type="button"
